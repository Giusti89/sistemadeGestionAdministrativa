<x-layouts.nuevos titulo="Registrar Gasto" css="./css/gastos.css">

    <section>
        <form method="POST" action="{{ route('storeGasto') }}">
            @csrf
            <h1>Nuevo Gasto</h1>
            ...
            <div class="inputbox">
                ...
                <input type="text" required id="concepto" name="concepto" :value="old('concepto')" autofocus
            ...
            <div class="inputbox">
                <ion-icon name="mail-outline"></ion-icon>
                <input type="number" required id="costo" name="costo" :value="old('costo')" autofocus
                    autocomplete="costo">
